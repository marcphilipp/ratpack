...
public interface Action<T> {
   ...
   * <p>
   * The exception is thrown via {@link ratpack.func.util.Exceptions#toException(Throwable)}
   *
  ...
  /**
   * Like {@link #with(Object, Action)}, but unchecks any exceptions thrown by the action via {@link ratpack.func.util.Exceptions#uncheck(Throwable)}.
   *
   * @param t the argument to execute the given action with
   * @param action the action to execute with the given argument
   * @param <T> the type of the argument
  ...
  /**
   * Like {@link #with(Object)}, but unchecks any exceptions thrown by the action via {@link ratpack.func.util.Exceptions#uncheck(Throwable)}.
   *
   ...
   * <p>
   * Any exceptions thrown by {@code this} action will be unchecked via {@link ratpack.func.util.Exceptions#uncheck(Throwable)} and rethrown.
   *
   ...
   * <p>
   * This can be used with methods to simulate the Java {@code finally} construct.
   *
