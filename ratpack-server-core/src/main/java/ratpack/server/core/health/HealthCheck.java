...
package ratpack.server.core.health;
 ...
 * The results exposed by health checks can be reported via HTTP by a {@link HealthCheckHandler}.
 * <p>
...
public interface HealthCheck {
   ...
   * import ratpack.exec.Promise;
   * import ratpack.exec.registry.Registry;
   * import ratpack.server.core.health.HealthCheck;
