...
package ratpack.server.core.http.client.internal;
...
import ratpack.server.core.http.client.StreamedResponse;
import ratpack.server.core.http.internal.DefaultStatus;
import ratpack.server.core.http.internal.NettyHeadersBackedHeaders;
