...
package ratpack.server.core.jackson;
...
import ratpack.server.core.jackson.internal.DefaultJsonParseOpts;
import ratpack.server.core.jackson.internal.DefaultJsonRender;
import ratpack.server.core.parse.NoOptParserSupport;
...
import ratpack.server.core.sse.ServerSentEvents;
 ...
 * import ratpack.server.core.jackson.Jackson;
 ...
 *
 * import static ratpack.server.core.jackson.Jackson.toJson;
 * import static ratpack.server.core.sse.ServerSentEvents.serverSentEvents;
...
public abstract class Jackson {
   ...
   * import java.util.Arrays;
   *
   * import static ratpack.server.core.jackson.Jackson.chunkedJsonList;
   * import static org.junit.Assert.*;
   *
   * public class Example {
   *   public static void main(String... args) throws Exception {
