...
package ratpack.server.core.service;
 ...
 * This means that implementations of these methods are free to perform async ops (e.g. use the {@link HttpClient HTTP client}, or {@link Blocking block}).
 * <pre class="java">{@code
 * import ratpack.server.core.RatpackServer;
 * import ratpack.server.core.ServerConfig;
 * import ratpack.server.core.service.Service;
 ...
 * In {@link ServerConfig#isDevelopment() development mode}, the application will start and display the error page for all requests with the error.
