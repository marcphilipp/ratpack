...
package ratpack.server.core.logging;
 ...
 * The term “context” here comes from SLF4J's lexicon and does not refer to Ratpack's {@link Context}.
 ...
 *
 * import ratpack.server.core.logging.MDCInterceptor;
 *
...
public final class MDCInterceptor implements ExecInterceptor {
   ...
   * <p>
   * The following demonstrates priming the MDC with the {@link RequestId}.
   *
   * <pre class="java">{@code
   * import org.slf4j.MDC;
   * import ratpack.server.core.handling.RequestId;
