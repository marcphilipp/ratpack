...
package ratpack.server.core.handling;

import ratpack.func.api.Nullable;
import ratpack.server.core.file.FileHandlerSpec;
import ratpack.server.core.file.internal.DefaultFileHandlerSpec;
import ratpack.server.core.file.internal.FileSystemBindingHandler;
import ratpack.func.Action;
import ratpack.func.Block;
import ratpack.func.Predicate;
import ratpack.func.util.FileSystemBinding;
import ratpack.server.core.handling.internal.*;
import ratpack.server.core.path.PathBinder;
import ratpack.server.core.path.PathBinding;
import ratpack.server.core.path.internal.PathHandler;
...
public abstract class Handlers {
   ...
   * <p>
   * The {@code path} is relative to the contextual {@link PathBinding} of the exchange.
   * <p>
   * A new contextual {@link PathBinding} will be established for the given handlers,
   ...
   * <p>
   * The {@code prefix} is relative to the contextual {@link PathBinding} of the exchange.
   * <p>
   * A new contextual {@link PathBinding} will be established for the given handlers,
