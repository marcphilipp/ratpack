...
import ratpack.server.core.http.internal.DefaultHttpMethod;
import ratpack.server.core.http.internal.HttpHeaderConstants;

public class MethodHandler implements Handler {

  private final ratpack.server.core.http.HttpMethod method;
  ...
  public void handle(Context context) {
    ratpack.server.core.http.HttpMethod requestMethod = context.getRequest().getMethod();
