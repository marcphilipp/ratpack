 ...
 * These strings can contain symbols that allow {@link PathTokens} to be captured and for path binding to be dynamic.
...
public interface Chain {
   ...
   * }</pre>
   * <p>
   * See {@link Handlers#prefix(String, Handler)}
   ...
   * <p>
   * The registry is inserted via the {@link Context#next(Registry)} method.
   *
