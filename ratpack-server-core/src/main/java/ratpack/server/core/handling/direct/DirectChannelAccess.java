...
package ratpack.server.core.handling.direct;
 ...
 * It exists to provide low level integration with Netty for extra protocols to build on, such as the {@link WebSockets} support.
 */
