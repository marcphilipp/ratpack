 ...
 * <p>
 * Handler decorators can be used to contribute to the handler chain from the {@link RatpackServerSpec#registry server registry}.
...
public interface HandlerDecorator {
   ...
   * usual {@link RatpackServerSpec#handlers(Action)}} method, e.g. from an external module.
   * <p>
   * The given handler should call {@link Context#next()} to delegate to the rest of the handlers.
   *
