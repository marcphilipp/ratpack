...
package ratpack.server.core.sse;
...
import ratpack.server.core.sse.internal.DefaultEvent;
import ratpack.server.core.sse.internal.ServerSentEventEncoder;
import ratpack.exec.stream.Streams;

/**
 * A {@link Context#render(Object) renderable} object for streaming server side events.
 * <p>
 * A {@link Renderer renderer} for this type is implicitly provided by Ratpack core.
 * <p>
 * Example usage:
 * <pre class="java">{@code
 * import org.reactivestreams.Publisher;
...
public class ServerSentEvents implements Renderable {
   ...
   * @return a {@link Context#render(Object) renderable} object
   */
