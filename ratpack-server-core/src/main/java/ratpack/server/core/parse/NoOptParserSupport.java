...
package ratpack.server.core.parse;
...
public abstract class NoOptParserSupport extends ParserSupport<Void> {
  ...
  /**
   * Delegates to {@link #parse(Context, TypedData, TypeToken)}, discarding the {@code} opts object of the given {@code parse}.
   *
   ...
   * @return the result of calling {@link #parse(Context, TypedData, TypeToken)}
   * @throws Exception any exception thrown by {@link #parse(Context, TypedData, TypeToken)}
   */
  @Override
